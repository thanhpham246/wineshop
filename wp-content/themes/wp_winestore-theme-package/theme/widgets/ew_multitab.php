						...
						<?php  
							...
							?>
									<li <?php if($class) echo "class='$class'";?>>
										<div class="avarta"><a href="<?php comment_link() ; ?>"><?php echo get_avatar( $comment->comment_author_email, 58,'mystery'  ); ?></a></div>
										<div class="detail">
			...
			<div class="accordion-tabs wd-widget-multitabs-accordion" id="<?php echo $random_id;?>" style="display:none;">			
				<div class="accordion-group">
					<div class="accordion-heading">
						<a class="accordion-toggle" href="#collapseOne-<?php echo $rand_id;?>" data-parent="#<?php echo $random_id;?>" data-toggle="collapse"><span><span><?php echo esc_attr($title_recent); ?></span></span></a>
					</div>
					<div class="accordion-body collapse" id="collapseOne-<?php echo $rand_id;?>">
				...
				<div class="accordion-group">
					<div class="accordion-heading">
						<a class="accordion-toggle" href="#collapseTwo-<?php echo $rand_id;?>" data-parent="#<?php echo $random_id;?>" data-toggle="collapse"><span><span><?php echo esc_attr($title_comment); ?></span></span></a>
					</div>
							...
							jQuery.debounce(1000, function() {
								if(windowWidth >=200 && windowWidth <= 768){
									jQuery(".widget_multitab > .accordion-tabs").each(function(index,value){
										...
										jQuery(value).find('#collapseOne-<?php echo $rand_id;?>').children().html(recentHtml);
										jQuery(value).find('#collapseTwo-<?php echo $rand_id;?>').children().html(cmtHtml);
