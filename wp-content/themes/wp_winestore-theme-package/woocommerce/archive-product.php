			...
			<div id="main">	
					...
					<div class="<?php if($_left_sidebar) echo "alpha";?> <?php if($_right_sidebar) echo "omega"?>">				
						...
						?>
							...
							<?php if ( apply_filters( 'woocommerce_show_page_title', true ) ) : ?>
								...
								<h1 class="page-title heading-title archive-product"><?php woocommerce_page_title(); ?></h1>
				...
				<?php if( $_right_sidebar  ): ?>
							<div id="right-sidebar" class="span6">
								...
								<?php
									if ( is_active_sidebar( $wd_category_prod_datas['cat_right_sidebar'] ) ) : ?>
										<ul class="xoxo">
											<?php dynamic_sidebar( $wd_category_prod_datas['cat_right_sidebar'] ); ?>
										</ul>
								<?php endif; ?>
								</div>
