	...
	class WP_Widget_Twitterupdate extends WP_Widget {
		...
		function widget( $args, $instance ) {
			...
			if($instance['username']){
				echo "<span class=\"follow-us-heading\"><a href=\"http://twitter.com/{$instance['username']}\" target=\"_blank\">";
								...
								<div id="twitter-box" style="overflow: hidden;">
									...
									<ul id="twitter-list">
										...
										<li class="status-item <?php echo $class;?>">
											<span class="tweet-content"><?php echo wd_twitterify($status->text);?></span>
