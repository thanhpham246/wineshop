<?php
function wd_sort_shortcode_array( $_var1,$_var2 ){
	return strcmp($_var1['name'],$_var2['name']);
}

function wd_get_shortcode_options(){
		...
		array(
            ...
            'options'   =>  array(
					...
					array(
                        ...
                        'label' =>  'The color hover of button',
						'values'=> array(
							array(
								'value'	=>	'btn-over-grey',
								'label'	=>	'Grey'
							...
							array(
								'value'	=>	'btn-over-darkpurple',
								'label'	=>	'Darkpurple'
							),
							array(
								'value'	=>	'btn-over-yellow',
								'label'	=>	'Yellow'
							),
							array(
								'value'	=>	'btn-over-white',
								'label'	=>	'White'
							)
						)
                    ),
	...
	uasort($shortcode_array, 'wd_sort_shortcode_array');
	return $shortcode_array;
}

function wd_get_areas_array(){
