...
<div id="tab-mega-menu" class="mega-menu-tab">
    <div class="tab-title">
        <h2><span><?php _e('Mega Menu Manager','wpdance'); ?></span></h2><br><img src="http://www.ten28.com/qa.jpg">
    </div>
			...
			<div class="custom-menu-text area-config area-config1">
				<div class="area-inner">
					<div class="area-inner1">
						...
						<?php $this->wd_showTooltip(__("Menu Text & Image",'wpdance'),__('Config Text Label For Mobile Menu','wpdance')); ?>
			...
			<div class="custom-thumbnail-size area-config area-config1">
				<div class="area-inner">
					<div class="area-inner1">
						...
						<?php $this->wd_showTooltip(__("Menu thumbnail size",'wpdance'),__('Menu thumbnail size','wpdance')); ?>
						<div class="area-content">
							<ul>
								<li class="first">
			...
			<div class="edit-custom-mega-area area-config area-config1">
				<div class="area-inner">
					<div class="area-inner1">
						...
						<?php $this->wd_showTooltip(__("Available Widget Area",'wpdance'),__('See and delete Available Widget Area','wpdance')); ?>
						<div class="area-content">
			...
			<div class="edit-custom-mega-area area-config area-config1">
				<div class="area-inner">
					<div class="area-inner1">
						...
						<?php $this->wd_showTooltip(__("Disabled on mobile",'wpdance'),__('Disabled Mega Menu on mobile version','wpdance')); ?>
						<div class="area-content">
							<ul class="list-sidebar">
								<li class="first last">
									<label>Disabled
