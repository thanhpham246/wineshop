			...
			<div class="enable-header-ads area-config area-config1">
				<div class="area-inner">
					<div class="area-inner1">
						...
						<?php $this->wd_showTooltip(__("Enable Header Advertisement",'wpdance'),__("Enable or disable header advertisement",'wpdance')); ?>
			...
			<div class="type-header-ads area-config area-config1">
				<div class="area-inner">
					<div class="area-inner1">
						...
						<?php $this->wd_showTooltip(__("Advertisement Type",'wpdance'),__("Select Advertisement Type",'wpdance')); ?>
						<div class="area-content">
			...
			<div class="url-banner-header area-config area-config1">
				<div class="area-inner">
					<div class="area-inner1">
						...
						<?php $this->wd_showTooltip(__("Url & Banner Title",'wpdance'),__("Config image url, banner url and banner title for header ads",'wpdance')); ?>
						<div class="area-content">
							<ul id="banner">
								<li class="first">
