			...
			<div class="images area-config area-config1">
				<div class="area-inner">
					<div class="area-inner1">
						...
						<?php $this->wd_showTooltip(__('Images','wpdance'),__('Upload logo, tagline and favor icon image for your site','wpdance')); ?>
			...
			<div class="images area-config area-config1">
				<div class="area-inner">
					<div class="area-inner1">
						...
						<?php $this->wd_showTooltip(__("Custom Image Size",'wpdance'),__('Change Your Custom Image Size.The Slider Item use this as params.After change image size,you have to regen thumbnail by going to "Tool => Regen. Thumbnails"','wpdance')); ?>
						<div class="area-content">
							<ul>
			...
			<div class="social-embbed area-config area-config1">
				<div class="area-inner">
					<div class="area-inner1">
						...
						<?php $this->wd_showTooltip(__("Sidebar Contact Content",'wpdance'),__('Sidebar Contact Content,parse your contact form 7 shortcode here.If you dont have one.Install pluggin Contact Form 7.Find Contact Menu on the left and create your own form','wpdance')); ?>
						<div class="area-content">
			...
			<div class="social-embbed area-config area-config1">
				<div class="area-inner">
					<div class="area-inner1">
						...
						<?php $this->wd_showTooltip(__("Copyright text",'wpdance'),__('Change Footer Copyright Text','wpdance')); ?>
						<div class="area-content">
