<div id="tab-custom-code-area" class="integration-tab">
	...
	<div class="tab-content">
		<form name="config-integration" method="POST" action="<?php echo admin_url('admin-ajax.php'); ?>" enctype="multipart/form-data" id="config-integration">
			<div class="code-head area-config area-config1">
				<div class="area-inner">
					<div class="area-inner1">
						...
						<?php $this->wd_showTooltip(__("Add code to top of your post",'wpdance'),__("Add your custom code (html and javascript)",'wpdance')); ?>
			...
			<div class="code-front-footer area-config area-config1">
				<div class="area-inner">
					<div class="area-inner1">
						...
						<?php $this->wd_showTooltip(__("Add code to bottom of your post (Before comments)",'wpdance'),__("Add your custom code (html and javascript) to bottom of your post",'wpdance')); ?>
						<div class="area-content">
			...
			<div class="google_analytics area-config area-config1">
				<div class="area-inner">
					<div class="area-inner1">
						...
						<?php $this->wd_showTooltip(__("Add code before < / body >",'wpdance'),__("Add code before < / body >",'wpdance')); ?>
						<div class="area-content">
			...
			<div class="google_analytics area-config area-config1">
				<div class="area-inner">
					<div class="area-inner1">
						...
						<?php $this->wd_showTooltip(__("Google Analytics",'wpdance'),__("Add your google analytics code",'wpdance')); ?>
						<div class="area-content">
			...
			<div class="custom_css area-config area-config1">
				<div class="area-inner">
					<div class="area-inner1">
						<h3 class="area-title"><?php _e('Custom CSS','wpdance'); ?></h3>
						<?php $this->wd_showTooltip(__("Custom CSS",'wpdance'),__("Add your custom css code",'wpdance')); ?>
						<div class="area-content">
							<textarea name="custom_css" class="full-width"><?php echo stripslashes(htmlspecialchars_decode(get_option(THEME_SLUG.'custom_css'))); ?></textarea>
						</div><!-- .area-content -->
					</div><!-- .area-inner1 -->
				</div><!-- .area-inner -->
			</div><!-- .google_analytics -->
