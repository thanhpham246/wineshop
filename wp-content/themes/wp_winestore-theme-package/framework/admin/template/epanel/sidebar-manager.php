			...
			<div class="create-custom-sidebar area-config area-config1">
				<div class="area-inner">
					<div class="area-inner1">
						...
						<?php $this->wd_showTooltip(__("Create New  Sidebar",'wpdance'),__('Create a new sidebar','wpdance')); ?>
			...
			<div class="edit-custom-sidebar area-config area-config1">
				<div class="area-inner">
					<div class="area-inner1">
						...
						<?php $this->wd_showTooltip(__("Available Sidebars",'wpdance'),__('See and delete Available sidebar','wpdance')); ?>
						<div class="area-content">
