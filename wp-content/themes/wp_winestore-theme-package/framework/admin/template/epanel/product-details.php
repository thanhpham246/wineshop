			...
			<div class="code-head area-config area-config1">
				<div class="area-inner">
					<div class="area-inner1">
						...
						<?php $this->wd_showTooltip(__("Config product detailed page",'wpdance'),__("Config product detailed page",'wpdance')); ?>
						<div class="area-content">
							...
							<div>
								...
								<?php wp_editor( stripslashes(htmlspecialchars_decode($wd_single_prod_datas['sharing_custom_code'])), 'sharing_custom_code',$_settings ); ?>
							</div>							
							...
							<div>
								<label>Ship & Return Content </label>
									<?php 
										wp_editor( stripslashes(htmlspecialchars_decode($wd_single_prod_datas['ship_return_content'])), 'ship_return_content',$_settings );
									?>								
							</div>								
							...
							<div>
								...
								<?php	wp_editor( stripslashes(htmlspecialchars_decode($wd_single_prod_datas['custom_tab_content'])), 'custom_tab_content',$_settings );	?>			
							</div>							
