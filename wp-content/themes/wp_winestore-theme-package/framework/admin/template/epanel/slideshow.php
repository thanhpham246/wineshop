			...
			<div class="main-slideshow area-config area-config1">
				<div class="area-inner">
					<div class="area-inner1">
						...
						<?php $this->wd_showTooltip(__("Main Slideshow",'wpdance'),__('Config delay time for main slideshow','wpdance')); ?>
			...
			<div class="slideshow1 area-config area-config1">
				<div class="area-inner">
					<div class="area-inner1">
						...
						<?php $this->wd_showTooltip(__("Slideshow at single page",'wpdance'),__("Config delay time for slideshow at single page",'wpdance')); ?>
						<div class="area-content">
							<ul>
								<li class="delaytime">
									<span class="label"><?php _e('Delay Time','wpdance')?></span>
