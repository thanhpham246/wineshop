	...
	generate:function(){
		...
		switch( type ){
			...
			case 'banner':
				...
				var _label_img = jQuery('#banner_label_img').val();
				...
				return '[banner link_url="' + _link_url + '" bg_image="' + _bg_image + '" bg_color="' + _bg_color + '" title="' + _title + '" title_color="' + _title_color + '" subtitle="' + _sub_title + '" subtitle_color="' + _sub_title_color + '" border_color="' + _border_color + '" top_padding="' + _top_padding + '" bottom_padding="' + _bottom_padding + '" left_padding="' + _left_padding + '" inner_stroke="' + _inner_stroke + '" inner_stroke_color="' + _inner_stroke_color + '" sep_padding="' + _sep_padding + '" sep_color="' + _sep_color + '" label="' + _label + '" label_text="' + _label_text + '" label_bg_color="' + _label_bg_color + '" label_text_color="' + _label_text_color + '" label_img="' + _label_img + '"]';
				break;				
			case 'hidden_phone':
			...
			case 'hightlight_text':
				...
				break;
			case 'testimonials':
				return '[testimonial number_items="'  + jQuery('#testimonial_number').val()+ '" style="' + jQuery('#testimonial_style').val()+'"]';
				break;	
			case 'feature':
				return '[feature slug="'  + jQuery('#feature_slug').val()+ '" id="' + jQuery('#feature_id').val() + '" title="' + jQuery('#feature_title').val() + '" thumbnail="' + jQuery('#feature_thumbnail').val() + '" excerpt="' + jQuery('#feature_excerpt').val() + '" content="' + jQuery('#feature_content').val() +'"]';
				break;	
			case 'slideshow':
			...
			case 'about':
				...
				return sc_result;
			case 'testimonial':
				var sc_result='[testimonial ' + 'testi_id="'+ jQuery('#testi_id').val() +'" ' + 'style="' + jQuery('input:radio[name=testi_style]:checked').val() + '"]';
				return sc_result;
			case 'recent_blogs':
