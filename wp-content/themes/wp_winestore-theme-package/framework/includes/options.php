<?php
global $wd_theme_options_default;
$wd_theme_options_default = array(
    'logo'              	=>  ''
    ,'icon'             	 	=>  ''
...
function wd_getCatIdsHomepageDefault(){
    $catids = get_all_category_ids();
    if(count($catids) > 3)
...
function wd_get_all_gallery_ids(){
    global $wpdb;
