<?php 
if ( ! function_exists( 'wd_theme_posted_on' ) ) :
/**
 * Prints HTML with meta information for the current post-date/time and author.
 *
 * @since WP Responsive
 */
function wd_theme_posted_on() {
	printf( __( '<span class="%1$s">Posted on</span> %2$s <span class="meta-sep">by</span> %3$s', 'wpdance' ),
...
if ( ! function_exists( 'wd_theme_posted_in' ) ) :
/**
 * Prints HTML with meta information for the current post (category, tags and permalink).
 *
 * @since WP Responsive
 */
function wd_theme_posted_in() {
