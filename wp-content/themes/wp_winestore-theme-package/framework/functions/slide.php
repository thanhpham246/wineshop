<?php
if(!function_exists ('wd_show_flex_slider')){
	function wd_show_flex_slider($post_id){
		if( (int)$post_id > 0 ){
...
if(!function_exists ('wd_show_prod_slider')){
	function wd_show_prod_slider( $product_tag = 'all-product-tags' ){
		$_short_code = "[featured_product_slider page_slider='1' columns='4' layout='big' per_page='12' title='' desc='' show_nav='1' show_icon_nav='1' show_image='1' show_title='1' show_sku='1' show_price='1' show_label='1' show_rating='1' product_tag='{$product_tag}']";
...
if(!function_exists ('wd_show_nivo_slider')){
	function wd_show_nivo_slider( $post_id = 0 ){
		if( (int)$post_id > 0 ){
