...
class WD_Walker_Nav_Menu extends Walker_Nav_Menu{
	...
	protected $lv1_order;
	protected $lv2_order;
	protected $lv0_subcount;
	protected $lv1_subcount;
	protected $lv0_desc;
	protected $lv1_desc;
	protected $parent_mega_enable;
	protected $parent_widecolumn;
	protected $parent_sidebar;
	protected $parent_sidebar_str;
	protected $search_style;
	protected $menu_config;
	protected $parent_fullwidth;
	protected $sum_column_count;
