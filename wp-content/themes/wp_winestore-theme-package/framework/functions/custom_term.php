...
?>
	...
	<div class="form-field">
		<label for="display_type"><?php _e( 'Left SideBar', 'wpdance' ); ?></label>
			<select name="cat_left_sidebar" id="_prod_cat_left_sidebar" class="postform">
				...
				<?php
					...
					foreach( $wd_default_sidebars as $key => $_sidebar ){
						echo "<option value='{$_sidebar['id']}'>{$_sidebar['name']}</option>";
					}
				?>
			</select>
	</div>
	...
	<div class="form-field">
		<label for="display_type"><?php _e( 'Right Sidebar', 'wpdance' ); ?></label>
