...
/*
	...
	Output :
		The html of sidebar.
*/
if(!function_exists('wd_ew_get_sidebar')){
	function wd_ew_get_sidebar($id_sidebar,$ul_class = 'xoxo',$id_area = '',$custom_class = ''){
		ob_start();
		?>
...
if(!function_exists('wd_ew_get_sidebar_div')){
	function wd_ew_get_sidebar_div($id_sidebar,$ul_class = 'xoxo',$id_area = '',$custom_class = ''){
		ob_start();
		?>
		<div <?php if($id_area) echo 'id="'.$id_area.'"';?> class="widget-area<?php if(!$custom_class) echo ' '.$custom_class;?>" role="complementary">
			<ul class="<?php echo $ul_class;?>" id="<?php echo friendlyURL($id_sidebar);?>">
