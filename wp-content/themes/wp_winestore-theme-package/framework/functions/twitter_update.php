...
if(!function_exists('wd_getLastXTwitterStatus')){
	function wd_getLastXTwitterStatus($userid,$x){
				...
				ob_start();
						...
						<div id="ticker-wrapper" class="no-js">
							...
							<ul id="js-news" class="js-hidden">
								...
								<li class="status-item"><a href="<?php echo 'http://twitter.com/'.$twitter_user.'/statuses/'.$status->id; ?>"><?php echo wd_twitterify($status->text);?></a></li>
								<?php endforeach;?>
							</ul>
							<?php endif;?>				
						</div><!-- #ticker-wrapper -->
...
if(!function_exists('wd_twitterify')){
	function wd_twitterify($ret) {
