...
//echo '<pre>'; print_r($portfolio_slider); echo '</pre>';
$portfolio_slider_config = get_post_meta($post->ID,'wd_portfolio_slider_config',true);
...
<div class="shortcode-config">
	...
	<span id="carousel-shortcode" name="carousel-shortcode">
		<select name="portfolio_slider_config_size">
			...
			<option value="prod_homepage2" <?php if( strcmp(esc_html($portfolio_slider_config['portfolio_slider_config_size']),'prod_homepage2') == 0 ) echo "selected";?>>Slider ( 120x120 )</option>
